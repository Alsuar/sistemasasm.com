...
<head>
	...
	<meta name="keywords" content="software administrativo,programas administrativos,catalogos virtuales,empresas al por mayor,sistema de facturacion">
	...
	<title>Punto de Venta Android con Factura Electrónica en Panamá</title>
</head>
<body>
	...
	<main>
		<div class="container fblank thumbnail">
			...
			<div class="tagline">
				<h1>Punto de Venta Android con Factura Electrónica en Panamá</h1> </div>
			<div class="container marketing">
				<div class="featuretit">
					<div class="row">
						<div class="col-lg-12">
							<h3>Sistema de Ventas y Gestión de Inventarios, Especialmente diseñado para Administrar tu Restaurante, Ferreterias, Comercio Minorista, Salas de Belleza, Taller Mecanico Automotriz, Servicio Técnico y mucho mas.</h3> 
						</div>
					</div>
				</div>
